...
export const CATEGORIES: { id: string; label: string; intro: string; items: Article[] }[] = [
  {
    ...
    items: [
      ...
      { title: "Should You Optimize Meta Ads for Add to Cart or Purchase?", desc: "More add-to-cart volume isn't the same signal as a purchase — when each optimization event actually helps.", href: "/resources/meta-ads-optimize-add-to-cart-or-purchase" },
      ...
      { title: "Should You Use Advantage+ Shopping Campaigns for Shopify?", desc: "Automation can't fix a weak offer or broken tracking — the business questions that decide it.", href: "/resources/advantage-plus-shopping-campaigns-shopify" },
      ...
      { title: "Meta Ads Frequency Too High: When Does It Become a Problem?", desc: "There's no universal ceiling — how to pair frequency with CTR, CPA and reach before reacting.", href: "/resources/meta-ads-frequency-too-high" },
      { title: "Should You Pause a Meta Ad That Has No Sales?", desc: "Zero sales isn't automatically a bad ad — how to judge it against target CPA and funnel activity.", href: "/resources/should-you-pause-meta-ad-no-sales" },
      ...
      { title: "UGC Ads vs Product Ads: Which Converts Better?", desc: "UGC and polished product ads communicate different kinds of proof — when each format wins.", href: "/resources/ugc-ads-vs-product-ads" },
      ...
      { title: "Meta Ads Campaign Budget vs Ad Set Budget: Which Should You Use?", desc: "CBO and ad set budgets answer different questions — how to choose based on the job.", href: "/resources/campaign-budget-vs-ad-set-budget-meta" },
      ...
      { title: "Should You Reuse Old Winning Meta Ads?", desc: "Old creative is worth retesting — it isn't guaranteed to become a winner again.", href: "/resources/should-you-reuse-old-winning-meta-ads" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Are Competitor Keywords Worth Bidding on in Google Ads?", desc: "The intent behind a competitor-name search isn't neutral — what that costs you.", href: "/resources/competitor-keywords-google-ads-worth-it" },
