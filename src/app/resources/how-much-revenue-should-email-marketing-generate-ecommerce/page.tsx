...
const ARTICLE_JSON_LD = {
  ...
  description: "There is no universal healthy percentage of revenue email 'should' generate. How to judge program health with Shopify as the revenue anchor instead of a benchmark.",
...
export default function Page() {
  return (
    <ProductPageShell>
      ...
      <section className="mx-auto max-w-3xl px-4 py-10">
        <Reveal>
          <h2 className="text-2xl md:text-3xl font-extrabold mb-4">Look at program health</h2>
