      ...
      <section className="mx-auto max-w-3xl px-4 py-10">
        <Reveal>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/resources/is-an-ecommerce-marketing-agency-worth-the-cost" className="text-cyan-300 underline underline-offset-4 hover:text-cyan-200">Is a Meta Ads Agency Worth It?</Link></li>
