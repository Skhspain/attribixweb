...
export const metadata: Metadata = {
  ...
  description:
    "Duplicate purchase events almost always trace back to Pixel and CAPI firing without a shared event ID, or more than one tracking app sending the same order. How to diagnose and fix it.",
