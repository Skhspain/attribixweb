...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.attribix.app/resources/how-to-build-an-ecommerce-creative-testing-system-that" },
  openGraph: {
    title: "How to Build an Ecommerce Creative Testing System That Produces Useful Learnings",
    description: "The final winner is not the ad with the highest hook rate or most comments.",
    url: "https://www.attribix.app/resources/how-to-build-an-ecommerce-creative-testing-system-that",
