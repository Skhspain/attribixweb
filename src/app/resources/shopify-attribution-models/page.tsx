...
const MODELS = [
  ...
  { name: "Linear", rewards: "Every touchpoint in the journey, equally.", weakness: "Treats a passing glance the same as a deliberate return visit — spreads credit without judging which touch actually mattered." },
