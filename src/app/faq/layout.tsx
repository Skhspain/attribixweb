...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.attribix.app/faq" },
  openGraph: { title: "FAQ | Attribix", description: "Common questions about attribution tracking for Shopify.", url: "https://www.attribix.app/faq" },
};
