      ...
      <main className="mx-auto max-w-6xl px-6 py-16 md:py-24">
        <div className="grid gap-16 md:grid-cols-2 md:items-start md:gap-20">
            ...
            <div className="mt-12 rounded-2xl border border-white/[0.07] bg-white/[0.03] p-6">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={point} className="flex items-center gap-3 text-sm text-white/45">
                    <svg className="h-4 w-4 shrink-0 text-cyan-500/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8 backdrop-blur-sm md:sticky md:top-10">
            ...
            <p className="mb-7 text-sm text-white/35">We&apos;ll confirm a time within one business day.</p>
            <ConsultationForm />
          </div>
